### Big Bang Simulator - Interactive Cosmic Playground
...
- R or Middle Click: Reset view

**Time Management:**
- Space: Pause/Resume
- Shift: Slow motion mode
- 1/2/3: Adjust expansion rate
...
**Note:** Selecting a star and zooming in reveals planetary orbits, with color indicating orbital distance.
